            ...
            <Stack gap="lg" justify="center" h="100%">
              <div>
                ...
                <Text size="lg" c="dimmed" mb="xl">
                  Đăng nhập để bắt đầu tìm kiếm và đặt khách sạn tuyệt vời trên toàn thế giới. Nhận thêm các ưu đãi độc quyền và quản lý đơn đặt phòng của bạn dễ dàng.
                </Text>
              </div>
...
const BenefitItem = ({ icon, title, description }: BenefitItemProps) => {
  return (
    <Box style={{ display: 'flex', gap: '1rem' }}>
      <Box style={{ fontSize: '1.5rem' }}>{icon}</Box>
      <Stack gap={0}>
        <Text fw={600} size="sm">
          {title}
        </Text>
